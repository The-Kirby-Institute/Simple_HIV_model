...
if (!file.exists(file.path(resultsFolder, "infectionresults0501.csv"))) {
write.csv(infectionresults, file = file.path(resultsFolder, "infectionresults0501.csv"))
}
...
totalinfectionresults_95PI$withoutcovid_value<-round((totalinfectionresults %>% filter(scenarios =="Without COVID-19 impact and remain",timestep == 32))$totalHIV,0)
totalinfectionresults_95PI$withoutcovid_upper<-round(quantile((totalinfectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and remain", timestep == 32))$totalHIV, probs = 0.975, names = FALSE),0)
totalinfectionresults_95PI$withoutcovid_lower<-round(quantile((totalinfectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and remain", timestep == 32))$totalHIV, probs = 0.025, names = FALSE),0)

totalinfectionresults_95PI$withoutcovid_withprep_value<-round((totalinfectionresults %>% filter(scenarios =="Without COVID-19 impact and with prep promotion",timestep == 32))$totalHIV,0)
totalinfectionresults_95PI$withoutcovid_withprep_upper<-round(quantile((totalinfectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and with prep promotion", timestep == 32))$totalHIV, probs = 0.975, names = FALSE),0)
totalinfectionresults_95PI$withoutcovid_withprep_lower<-round(quantile((totalinfectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and with prep promotion", timestep == 32))$totalHIV, probs = 0.025, names = FALSE),0)

totalinfectionresults_95PI$withcovid_value<-round((totalinfectionresults %>% filter(scenarios == "With COVID-19 impact",timestep == 32))$totalHIV,0)
totalinfectionresults_95PI$withcovid_upper<-round(quantile((totalinfectionresults_sim %>% filter(scenarios == "With COVID-19 impact", timestep == 32))$totalHIV, probs = 0.975, names = FALSE),0)
totalinfectionresults_95PI$withcovid_lower<-round(quantile((totalinfectionresults_sim %>% filter(scenarios == "With COVID-19 impact", timestep == 32))$totalHIV, probs = 0.025, names = FALSE),0)
totalinfectionresults_95PI

cumuinfectionresults_95PI<-list()
cumuinfectionresults_95PI$withoutcovid_value<-round((infectionresults %>% filter(scenarios =="Without COVID-19 impact and remain",timestep == 32))$csum_infection,0)
cumuinfectionresults_95PI$withoutcovid_upper<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and remain", timestep == 32))$csum_infection, probs = 0.975, names = FALSE),0)
cumuinfectionresults_95PI$withoutcovid_lower<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and remain", timestep == 32))$csum_infection, probs = 0.025, names = FALSE),0)

cumuinfectionresults_95PI$withoutcovid_withprep_value<-round((infectionresults %>% filter(scenarios =="Without COVID-19 impact and with prep promotion",timestep == 32))$csum_infection,0)
cumuinfectionresults_95PI$withoutcovid_withprep_upper<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and with prep promotion", timestep == 32))$csum_infection, probs = 0.975, names = FALSE),0)
cumuinfectionresults_95PI$withoutcovid_withprep_lower<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and with prep promotion", timestep == 32))$csum_infection, probs = 0.025, names = FALSE),0)

cumuinfectionresults_95PI$withcovid_value<-round((infectionresults %>% filter(scenarios == "With COVID-19 impact",timestep == 32))$csum_infection,0)
cumuinfectionresults_95PI$withcovid_upper<-round(quantile((infectionresults_sim %>% filter(scenarios == "With COVID-19 impact", timestep == 32))$csum_infection, probs = 0.975, names = FALSE),0)
cumuinfectionresults_95PI$withcovid_lower<-round(quantile((infectionresults_sim %>% filter(scenarios == "With COVID-19 impact", timestep == 32))$csum_infection, probs = 0.025, names = FALSE),0)
cumuinfectionresults_95PI


cumudiagnosisresults_95PI<-list()
cumudiagnosisresults_95PI$withoutcovid_value<-round((infectionresults %>% filter(scenarios =="Without COVID-19 impact and remain",timestep == 32))$csum_diagnosis,0)
cumudiagnosisresults_95PI$withoutcovid_upper<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and remain", timestep == 32))$csum_diagnosis, probs = 0.975, names = FALSE),0)
cumudiagnosisresults_95PI$withoutcovid_lower<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and remain", timestep == 32))$csum_diagnosis, probs = 0.025, names = FALSE),0)

cumudiagnosisresults_95PI$withoutcovid_withprep_value<-round((infectionresults %>% filter(scenarios =="Without COVID-19 impact and with prep promotion",timestep == 32))$csum_diagnosis,0)
cumudiagnosisresults_95PI$withoutcovid_withprep_upper<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and with prep promotion", timestep == 32))$csum_diagnosis, probs = 0.975, names = FALSE),0)
cumudiagnosisresults_95PI$withoutcovid_withprep_lower<-round(quantile((infectionresults_sim %>% filter(scenarios == "Without COVID-19 impact and with prep promotion", timestep == 32))$csum_diagnosis, probs = 0.025, names = FALSE),0)

cumudiagnosisresults_95PI$withcovid_value<-round((infectionresults %>% filter(scenarios == "With COVID-19 impact",timestep == 32))$csum_diagnosis,0)
cumudiagnosisresults_95PI$withcovid_upper<-round(quantile((infectionresults_sim %>% filter(scenarios == "With COVID-19 impact", timestep == 32))$csum_diagnosis, probs = 0.975, names = FALSE),0)
cumudiagnosisresults_95PI$withcovid_lower<-round(quantile((infectionresults_sim %>% filter(scenarios == "With COVID-19 impact", timestep == 32))$csum_diagnosis, probs = 0.025, names = FALSE),0)
cumudiagnosisresults_95PI
...
#Save output in some form Rda file and/or csv
# If file not already created make sure it is not overwritten
if (!file.exists(file.path(resultsFolder, "infectionresults_sim_20240511.csv"))) {
write.csv(infectionresults_sim, file = file.path(resultsFolder, "infectionresults_sim_20240511.csv"))
}
if (!file.exists(file.path(resultsFolder, "quantile_interval_band_newHIV_20240512.csv"))) {
write.csv(quantile_interval_band_newHIV, file = file.path(resultsFolder, "quantile_interval_band_newHIV_20240512.csv"))
}
if (!file.exists(file.path(resultsFolder, "newinfectionresults_peryear_95PI_20240511.csv"))) {
write.csv(newinfectionresults_peryear_95PI, file = file.path(resultsFolder, "newinfectionresults_peryear_95PI_20240511.csv"))
}
