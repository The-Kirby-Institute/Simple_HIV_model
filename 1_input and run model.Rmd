...
hivtimeseriesFile<- file.path(dataFolder,  "hiv_time_series_data_test1.csv")
...
if (!file.exists(file.path(resultsFolder, "newinfections_peryear1213_2.csv"))) {
write.csv(newinfections_peryear, file = file.path(resultsFolder, "newinfections_peryear1213_2.csv"))
}
```
