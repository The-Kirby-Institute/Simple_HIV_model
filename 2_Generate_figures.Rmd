...
if (!file.exists(file.path(figFolder, "new_HIV_infection_sim_20240305_3scenarios.png"))) {
    SaveFigure(figFolder,"new_HIV_infection_sim_20240305_3scenarios",newinfectionfig_sim)
}
```
