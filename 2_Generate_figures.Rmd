...
newinfectionfig_sim_band<- ggplot()+
  ...
  scale_colour_manual(name = "", 
    ...
    labels = c("With COVID-19","No COVID-19","No COVID-19 plus\nPrEP promotion")) +
...
newinfectionfig_sim_band_twoscenarios<- ggplot()+
  ...
  ylab("Number of new HIV infections")+
  ylim(0,signif(max(quantile_interval_band_newHIV$upperbound),1))
newinfectionfig_sim_band_twoscenarios<- newinfectionfig_sim_band_twoscenarios+ theme_classic()
...
if (!file.exists(file.path(figFolder, "newinfectionfig_sim_band_twoscenarios.png"))) {
    SaveFigure(figFolder,"newinfectionfig_sim_band_twoscenarios",newinfectionfig_sim_band_twoscenarios)
}
if (!file.exists(file.path(figFolder, "newinfectionfig_sim_band_20240511.png"))) {
    SaveFigure(figFolder,"newinfectionfig_sim_band_20240511.png",newinfectionfig_sim_band)
}
```
...
if (!file.exists(file.path(figFolder, "newinfections_diagnosis_peryear_fig20240511.png"))) {
    SaveFigure(figFolder,"newinfections_diagnosis_peryear_fig20240511",combined_figure)
}
