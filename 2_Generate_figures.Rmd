...
if (!file.exists(file.path(figFolder, "new_HIV_infection2.png"))) {
    SaveFigure(figFolder,"new_HIV_infection3",newinfectionfig)
}
...
# If figure not already created make sure it is not overwritten
if (!file.exists(file.path(figFolder, "Cumulated_HIV_infection2.png"))) {
    SaveFigure(figFolder,"Cumulated_HIV_infection2",cumulatedinfectionfig)
}
