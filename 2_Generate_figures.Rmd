...
black_newinfectionfig_sim_band <- ggplot() +
  ...
  #---------------------------------------------------------------------------
  # MAIN LINES: forced black color but linetype depends on scenario
  #---------------------------------------------------------------------------
  geom_line(
    data = quantile_interval_band_newHIV,
    aes(x = timestep, y = newHIV,
  ...
  #---------------------------------------------------------------------------
  # MANUAL SCALES: 
  #   1) Same name ("Scenario") for fill, color, linetype
  #   2) Identical breaks & labels
  #---------------------------------------------------------------------------
  scale_fill_manual(
    name   = "Scenario",
...
if (!file.exists(file.path(figFolder, "black_newinfectionfig_sim_band_2025020501.png"))) {
    SaveFigure(figFolder,"black_newinfectionfig_sim_band_2025020501.png",black_newinfectionfig_sim_band)
}
